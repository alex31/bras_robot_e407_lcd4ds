...
void prvGetRegistersFromStack( uint32_t *pulFaultStackAddress )
{
  ...
  /*
    ...
    disassemble 0x«address» : see the assembly of the address which has triggered exception
    info line *0x«address» : see the source code of the line which has triggered exception
   */
