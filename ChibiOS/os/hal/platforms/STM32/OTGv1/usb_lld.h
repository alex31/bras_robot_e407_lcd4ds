...
#if defined ALLOW_OVERCLOCK
#if (STM32_USBCLK < 47000000) || (STM32_USBCLK > 49000000)
#pragma message "the USB OTG driver requires a 48MHz clock instead of " STR(STM32_USBCLK)
#endif
#else
#if STM32_USBCLK != 48000000
#error message "the USB OTG driver requires a 48MHz clock"
#endif
#endif
